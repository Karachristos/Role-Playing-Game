...
Η πύλη θα ανοίξει αυτόματα αν ο παίκτης τη πλησιάσει έχοντας ένα κλειδί.
...
-Να γίνουν τα δωμάτια scenes έτσι ώστε να να προσθεθούν camera transitions από το ένα δωμάτιο στο άλλο.
