...
Βρίσκοντας τις αισθήσεις του συνειδητοποιεί πως όλοι οι ανθρώποι του μπουντρουμιού είναι λείπουν και τα μόνα πλάσματα που τριγυρνούν στο μπουντρούμοι είναι οπλοισμένοι ποντικοί.
...
Στη συνέχεια έκανα animate τον ήρωα αλλά και τους εθρούς χρησιμοποιώντας τον animator της unity. Ο ήρωας έχει idle animations ανάλογα με το πιο πλήκτρο έχω πατήσει τελευταίο (IdleLeft αν το τελευταίο πατημένο πλήκτρο ήταν το A). Επίσης έχει διαφορετικά animations ανάλογα με το ποιά μεριά κινείται. Ωστόσο, επειδή τα assets του ήρωα είναι φτιαγμένα για sidescrollers, δεν είχα animation sheets για up and down movement γι'αυτό και έβαλα στη θέση τους τα animations για left and rigth movement. (Όταν βρω κατάλληλο χαρακτήρα θα προσθεθεί και το σωστό up and down movement). O ήρωας θα παίζει επίσης ένα hit animation κάθε φορα που τραυματίζεται.

Το ίδιο έκανα και με του εχθρούς. Οι ποντικάνθρωποι τώρα έχουν movement animations αλλά και death animation.
...
Ο ήρωας τώρα παίζει attack animation κάθε φορά που πατιέται το πλήκτρο C και το projectile εκτοξεύεται ανάλογως το direction στο οποίο κινείται ο ήρωας (αν μετακινείται προς τα πάνω το projectile εκτοξεέυται προς τα πάνω).
